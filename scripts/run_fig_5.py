...
import numpy as np
from src.functions_simulate import simulate_weighting_example, simulate_slope_vs_trial_duration, simulate_slope_vs_variances
...
if run_cell:
    ...
    if not plot_only:
        ...
        [_, fitted_slopes_1] = simulate_slope_vs_variances(mfn_flag, min_mean, max_mean, m_std, input_stds, file_for_data = file_for_data_1)
        ...
        [_, fitted_slopes_2] = simulate_slope_vs_variances(mfn_flag, min_mean, max_mean_arr, m_std, n_std, file_for_data = file_for_data_2)
...
if run_cell:
    ...
    if not plot_only:
        ...
        [n_trials, _, _, stimuli_1, _, _, _, _,
         _, _, weighted_output_1, trial_means_1] = simulate_weighting_example(mfn_flag, min_mean, max_mean, m_std, n_std_1,
                                                                              file_for_data = file_for_data_1)
        
        ## run for larger range 
        [n_trials, _, _, stimuli_2, _, _, _, _,
         _, _, weighted_output_2, trial_means_2] = simulate_weighting_example(mfn_flag, min_mean, max_mean, m_std, n_std_2,
...
if run_cell:
    ...
    if not plot_only:
        ...
        [_, fitted_slopes_1] = simulate_slope_vs_trial_duration(mfn_flag, min_mean, max_mean, m_std, n_std, trial_durations, 
                                                                file_for_data = file_for_data_1)  
        ...
        ### run networks with different trial durations
        [_, fitted_slopes_2] = simulate_slope_vs_trial_duration(mfn_flag, min_mean, max_mean, m_std, n_std, trial_durations, 
                                                                file_for_data = file_for_data_2)  
