...
plot_neuromod_impact_inter(1, 0, 1, axs=axs)#, flg_plot_xlabel=False, flg_plot_bars=False)
plot_neuromod_impact_inter(2, 0, 1, axs=axs)
plot_neuromod_impact_inter(0, 0, 1, axs=axs)
