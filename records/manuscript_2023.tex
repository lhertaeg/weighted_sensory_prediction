...
% evidence for the model (PE neurons, connectivity PE --> M, predictions or P neurons exist, P neurons may hold the mean, time constants change along hierarchy)
...
% selectivity? One-dimensional system (wahrscheinlich nicht)

% link to Kalman filter and maybe Bayes surprise factor

----
% Katha feedback: predictions, postdictions, experiments vorschlagen, limitations, grosserer kontext, abgrenzung zu reward prediction error
